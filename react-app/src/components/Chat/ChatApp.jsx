...
import { abi } from "contracts/HashBox.json";
import { HashBoxAddress } from "contracts/config/networkAddress.jsx";

// Add the contract address inside the quotes
const CONTRACT_ADDRESS = HashBoxAddress;
      ...
      <Row>
        ...
        <Col xs={8} style={{ paddingLeft: "0px" }}>
          <div style={{ backgroundColor: "#DCDCDC", height: "100%" }}>
            ...
            <div style={{ height: "400px", overflowY: "auto" }}>{Messages}</div>
            ...
            >
              ...
              >
                <Form.Row>
                  <Col xs={9}>
                    <Form.Control id="messageData" placeholder="Send Message" />
                  </Col>
                  <Col>
                    <Button
                      style={{ float: "right" }}
