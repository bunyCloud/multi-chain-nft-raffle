...
var versionUser =
  " use solidity version 0.8.17 and add licence line at the top and add documentation of each function and also explain code at the end of file.";
...
export default function MainGPT() {
  ...
  const OpenInRemixButton = ({ fileUrl, fileCode }) => {
    const fileCodeBase64 = Base64.encode(fileCode);
        ...
        <div className="row px-2 py-2">
          ...
          >
            <div className="px-2 py-4 text-left flex-grow-1">
              <h4 className="">Generate Solidity Smart Contract</h4>
              <br></br>
              <div className="">
                <select
