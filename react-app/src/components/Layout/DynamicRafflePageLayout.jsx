...
import DynamicRafflePage from "./DynamicRafflePage";
...
export default function DynamicRafflePageLayout(props) {
...
//                  height: "50px",
           ...
           <Wrap spacing="5px" justify="center">
                ...
                <Center w="auto" bg="#8f8d9b" border="0px solid #fe9d97">
                  <Wrap m={15}>
                    <WrapItem>
                      <DynamicRafflePage refreshPage={refreshPage} provider={provider} />
                    </WrapItem>
                  </Wrap>
                </Center>
              </Content>
