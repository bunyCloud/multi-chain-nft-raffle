...
function BunyBankInterface() {
  ...
  async function deposit() {
    ...
    const contract = new ethers.Contract(TelosBunyBankAddress, BunyBankTelos.abi, signer)
    ...
    <Box p={25} bg="#bbdccb" mt={15} w={250} mb={5}>
      ...
      <Stack spacing={4}>
        ...
        <HStack mt={5}>
          ...
          <Button href={`https://teloscan.io/address/${owner1}/`} type="link" size="small">
        ...
        <HStack>
          ...
          <Button href={`https://teloscan.io/address/${owner2}/`} type="link" size="small">
            <div style={{ marginBottom: '8px', fontSize: '12px' }}>
