...
function BunyBankApp() {
  ...
  const { onCopy, value, setValue, hasCopied } = useClipboard(BunyBankTelosAddress)
                                ...
                                <HStack>
                                  <div style={{ marginBottom: '8px', fontSize: '12px' }}>
                                    {BunyBankTelosAddress &&
                                      `${BunyBankTelosAddress.slice(0, 18)}...${BunyBankTelosAddress.slice(
                                        BunyBankTelosAddress.length - 18,
                                        BunyBankTelosAddress.length
                                      )}`}
                                  </div>
                                  <IconButton
