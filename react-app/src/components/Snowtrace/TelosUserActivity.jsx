...
const apiEndpoint = 'https://telos.eosauthority.com/v2/history/get_actions?account=<YOUR_ACCOUNT_NAME>&skip=<NUMBER_OF_ACTIONS_TO_SKIP>&limit=<NUMBER_OF_ACTIONS_TO_RETURN>&sort=desc&simple=true';
