...
function FantomTestnetRaffleFactory(props) {
  ...
  async function createThisRaffle() {
    ...
    setDeploy(`https://testnet.ftmscan.com/tx/${transaction.hash}`);
    contract.on(
      "CreatedEdition",
      (
        editionId,
          ...
          <VStack>
            ...
            <HStack gap={5}>
              <div style={{ marginBottom: "5px" }}>
                <Link
                  href={`https://testnet.ftmscan.com/address/${FantomTestnetRaffleFactoryAddress}`}
                  color="blue"
                  m={5}
                  target={"_blank"}
                >
              ...
              <div style={{ marginBottom: "5px" }}>
                <Link
                  href={`https://testnet.ftmscan.com/address/${FantomTestnetRaffleNftAddress}`}
                  color="blue"
                  m={5}
                  target={"_blank"}
                >
...
export default FantomTestnetRaffleFactory;
