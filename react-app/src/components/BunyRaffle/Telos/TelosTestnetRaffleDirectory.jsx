...
import { TelosTestnetRaffleFactoryAddress } from "contracts/config/networkAddress";
import {
  Box,
  Flex,
  HStack,
...
export default function TelosTestnetRaffleDirectory() {
      ...
      <Flex mt="15px" p={5}>
        <VStack>
          <Center>
            ...
            >
              <Descriptions title="All Telos Raffles">
                <Descriptions.Item label="Network">
                  <img
                    width="20px"
                    src="https://ipfs.io/ipfs/QmTP4rtdGE25fgARUykg2Tw6HEP8YftnstZeiqfxCKQK8k"
                  ></img>
                </Descriptions.Item>
                ...
                <Descriptions.Item label="Status">
                  <Badge status="error" text="Testnet" />
                </Descriptions.Item>
              </Descriptions>
