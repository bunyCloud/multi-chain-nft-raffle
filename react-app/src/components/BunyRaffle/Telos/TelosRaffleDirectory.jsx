...
import ConnectButton from 'components/UseDapp/ConnectButtonBeta'

export default function TelosRaffleDirectory() {
            ...
            <Box
              ...
              <Descriptions title="All Telos Raffles">
                <Descriptions.Item label="Network">
                  <img
                    width="20px"
                    src="https://assets-global.website-files.com/60ae1fd65f7b76f18ddd0bec/61044a5f70f5bbeb24b995ea_Symbol%202%402x.png"></img>
                </Descriptions.Item>
