        ...
        <Center bg="rgb(229 231 235)">
          <HStack gap={5}>
            <div style={{ marginBottom: "5px" }}>
              <Link
                href={`https://teloscan.io/address/${TelosRaffleFactoryAddress}`}
                color="blue"
                m={5}
                target={"_blank"}
              >
            ...
            <div style={{ marginBottom: "5px" }}>
              <Link
                href={`https://teloscan.io/address/${TelosRaffleNftAddress}`}
                color="blue"
                m={5}
                target={"_blank"}
              >
...
export default TelosRaffleFactory;
