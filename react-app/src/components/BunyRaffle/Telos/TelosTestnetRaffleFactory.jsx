...
import raffleFactory from "contracts/telosTestnet/BunyRaffleFactory.json";
import {
...
function TelosTestnetRaffleFactory(props) {
  ...
  async function createThisRaffle() {
    ...
    setDeploy(`https://testnet.teloscan.io/tx/${transaction.hash}`);
    contract.on(
      "CreatedEdition",
      (
        editionId,
  ...
  return (
    <>
      ...
      >
        ...
        <h6 style={{ color: "Blue" }}>Telos Testnet</h6>
        <Center bg="rgb(229 231 235)">
          <HStack gap={5}>
            <div style={{ marginBottom: "5px" }}>
              <Link
                href={`https://testnet.teloscan.io/address/${TelosTestnetRaffleFactoryAddress}`}
                color="blue"
                m={5}
                target={"_blank"}
              >
            ...
            <div style={{ marginBottom: "5px" }}>
              <Link
                href={`https://testnet.teloscan.io/address/${TelosTestnetRaffleNftAddress}`}
                color="blue"
                m={5}
                target={"_blank"}
              >
...
export default TelosTestnetRaffleFactory;
