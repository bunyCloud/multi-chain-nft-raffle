...
import raffleFactory from "contracts/mumbai/BunyRaffleFactory.json";
import {
...
function MumbaiRaffleFactory(props) {
  ...
  async function createThisRaffle() {
    ...
    setDeploy(`https://mumbai.polygonscan.com/tx/${transaction.hash}`);
    contract.on(
      "CreatedEdition",
      (
        editionId,
          ...
          <VStack>
            ...
            <HStack gap={5}>
              <div style={{ marginBottom: "5px" }}>
                <Link
                  href={`https://snowtrace.io/address/${MumbaiRaffleFactoryAddress}`}
                  color="blue"
                  m={5}
                  target={"_blank"}
                >
              ...
              <div style={{ marginBottom: "5px" }}>
                <Link
                  href={`https://snowtrace.io/address/${MumbaiRaffleNftAddress}`}
                  color="blue"
                  m={5}
                  target={"_blank"}
                >
...
export default MumbaiRaffleFactory;
