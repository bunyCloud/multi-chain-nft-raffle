...
function AvalancheRaffleFactory(props) {
  ...
  async function createThisRaffle() {
    ...
    setDeploy(`https://snowtrace.io/tx/${transaction.hash}`);
    contract.on(
      "CreatedEdition",
      (
        editionId,
          ...
          <VStack>
            ...
            <HStack gap={5}>
              <div style={{ marginBottom: "5px" }}>
                <Link
                  href={`https://snowtrace.io/address/${avalancheRaffleFactoryAddress}`}
                  color="blue"
                  m={5}
                  target={"_blank"}
                >
              ...
              <div style={{ marginBottom: "5px" }}>
                <Link
                  href={`https://snowtrace.io/address/${avalancheRaffleNftAddress}`}
                  color="blue"
                  m={5}
                  target={"_blank"}
                >
...
export default AvalancheRaffleFactory;
