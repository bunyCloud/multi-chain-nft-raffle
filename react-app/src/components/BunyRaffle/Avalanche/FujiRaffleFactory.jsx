  ...
  return (
    <>
      ...
      >
        ...
        <h6 style={{ color: "Blue" }}>Avalanche Fuji Testnet</h6>
        <Center bg="rgb(229 231 235)">
          <HStack gap={5}>
            <div style={{ marginBottom: "5px" }}>
              <Link
                href={`https://testnet.snowtrace.io/address/${BunyRaffleFactoryAddress}`}
                color="blue"
                m={5}
                target={"_blank"}
              >
            ...
            <div style={{ marginBottom: "5px" }}>
              <Link
                href={`https://testnet.snowtrace.io/address/${BunyRaffleNftAddress}`}
                color="blue"
                m={5}
                target={"_blank"}
              >
...
export default FujiRaffleFactory;
