...
import { Center, Box, HStack, GridItem, Grid, VStack } from "@chakra-ui/react";
...
function BunyRaffleTwo() {
  ...
  //const editionContractAddress = "0xC84e49C62A8C1F2b696D35e30678B48301c2f42c"; #2
  const editionContractAddress = "0xC84e49C62A8C1F2b696D35e30678B48301c2f42c";
          ...
          <VStack>
            <Center>
              <HStack fontWeight="bold" color="orange" fontSize="26px">
                <div>Buny Raffle: Win: 10 /AVAX. </div>
              </HStack>
            </Center>
            <AutoCenter>
              <HStack>
              ...
              <Box>
                ...
                <Center>
                  <Button type="primary" block onClick={mintToken}>
                    <Center>
                      Mint{" "}
                      <div style={{ marginLeft: "10px" }}>{salesPrice}</div>{" "}
                      /avax
                    </Center>
                  </Button>
                </Center>
            ...
            <Box mt={6} p={5} w={380} bg="white">
              ...
              <Center>
                <Grid templateColumns="repeat(5, 1fr)" gap={2} color="black">
                  <GridItem colSpan={2} h="100%" bg="transparent" w={120}>
                    <Center>
                      <List spacing={3}>
                        <ListItem>
                          <HStack>
