import NFTMarketplaceAbi from "../../contracts/erc721Dynamic.json";
import {
  FileSearchOutlined,
  TransactionOutlined,
  ProfileOutlined,
...
import { Tooltip, Modal, Image, Row, Col, InputNumber } from "antd";
import {
...
export default function AvatarCardMini({ nft, url = "/" }) {
            ...
            <HStack mt={0} ml={8} gap={6}>
              ...
              >
                <Tooltip title="Block Explorer">
                  <Link
                    href={`https://snowtrace.io/token/${avatarAddress}?a=${nft.tokenId}`}
                    target="_blank"
                  >
                    <Center>
                      <FileSearchOutlined
              ...
              >
                <Tooltip title="NFT Details Page">
                  <Link href={`${url}${avatarAddress}/${nft.tokenId}`}>
                    <Center>
                      <ProfileOutlined
                        style={{
                          color: "blue",
